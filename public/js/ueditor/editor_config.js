...
(function () {
    ...
    var tmp = window.location.pathname,
        URL = "./js/ueditor/";
        //URL= tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("js/ueditor/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        ...
        'body{margin:8px;font-family:"微软雅黑";font-size:12px;}' +
